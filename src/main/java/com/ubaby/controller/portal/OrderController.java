...
public class OrderController {
    ...
    @ResponseBody
    public ServerResponse<PageInfo<OrderVO>> list(HttpSession session, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize) {
