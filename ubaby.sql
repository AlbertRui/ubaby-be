...
-- ----------------------------
--  Table structure for `ubaby_cart`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_cart`;
CREATE TABLE `ubaby_cart` (
...
-- ----------------------------
--  Records of `ubaby_cart`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_cart` VALUES ('126', '21', '26', '1', '1', '2017-04-13 21:27:06', '2017-04-13 21:27:06');
COMMIT;

-- ----------------------------
--  Table structure for `ubaby_category`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_category`;
CREATE TABLE `ubaby_category` (
  `id`          INT(11) NOT NULL AUTO_INCREMENT
  COMMENT '类别Id',
...
-- ----------------------------
--  Records of `ubaby_category`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_category` VALUES ('100001', '0', '家用电器', '1', NULL, '2017-03-25 16:46:00', '2017-03-25 16:46:00'),
...
-- ----------------------------
--  Table structure for `ubaby_order`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_order`;
CREATE TABLE `ubaby_order` (
  `id`           INT(11) NOT NULL AUTO_INCREMENT
  COMMENT '订单id',
...
-- ----------------------------
--  Records of `ubaby_order`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_order` VALUES
...
-- ----------------------------
--  Table structure for `ubaby_order_item`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_order_item`;
CREATE TABLE `ubaby_order_item` (
  `id`                 INT(11) NOT NULL AUTO_INCREMENT
  COMMENT '订单子表id',
  `user_id`            INT(11)          DEFAULT NULL,
  `order_no`           BIGINT(20)       DEFAULT NULL,
...
-- ----------------------------
--  Records of `ubaby_order_item`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_order_item` VALUES
...
-- ----------------------------
--  Table structure for `ubaby_pay_info`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_pay_info`;
CREATE TABLE `ubaby_pay_info` (
  `id`              INT(11) NOT NULL AUTO_INCREMENT,
  `user_id`         INT(11)          DEFAULT NULL
  COMMENT '用户id',
  `order_no`        BIGINT(20)       DEFAULT NULL
...
-- ----------------------------
--  Records of `ubaby_pay_info`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_pay_info` VALUES
...
-- ----------------------------
--  Table structure for `ubaby_product`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_product`;
CREATE TABLE `ubaby_product` (
  `id`          INT(11)        NOT NULL AUTO_INCREMENT
  COMMENT '商品id',
  `category_id` INT(11)        NOT NULL
  COMMENT '分类id,对应ubaby_category表的主键',
...
-- ----------------------------
--  Records of `ubaby_product`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_product` VALUES
  ('26', '100002', 'Apple iPhone 7 Plus (A1661) 128G 玫瑰金色 移动联通电信4G手机', 'iPhone 7，现更以红色呈现。',
         ...
         '<p><img alt=\"10000.jpg\" src=\"http://img.ubaby.rzhang.xin/00bce8d4-e9af-4c8d-b205-e6c75c7e252b.jpg\" width=\"790\" height=\"553\"><br></p><p><img alt=\"20000.jpg\" src=\"http://img.ubaby.rzhang.xin/4a70b4b4-01ee-46af-9468-31e67d0995b8.jpg\" width=\"790\" height=\"525\"><br></p><p><img alt=\"30000.jpg\" src=\"http://img.ubaby.rzhang.xin/0570e033-12d7-49b2-88f3-7a5d84157223.jpg\" width=\"790\" height=\"365\"><br></p><p><img alt=\"40000.jpg\" src=\"http://img.ubaby.
  ...
  ('29', '100008', 'Haier/海尔HJ100-1HU1 10公斤滚筒洗衣机全自动带烘干家用大容量 洗烘一体', '门店机型 德邦送货',
         ...
         '<p><img alt=\"1TB2WLZrcIaK.eBjSspjXXXL.XXa_!!2114960396.jpg\" src=\"http://img.ubaby.rzhang.xin/ffcce953-81bd-463c-acd1-d690b263d6df.jpg\" width=\"790\" height=\"920\"><img alt=\"2TB2zhOFbZCO.eBjSZFzXXaRiVXa_!!2114960396.jpg\" src=\"http://img.ubaby.rzhang.xin/58a7bd25-c3e7-4248-9dba-158ef2a90e70.jpg\" width=\"790\" height=\"1052\"><img alt=\"3TB27mCtb7WM.eBjSZFhXXbdWpXa_!!2114960396.jpg\" src=\"http://img.ubaby.rzhang.xin/2edbe9b3-28be-4a8b-a9c3-82e40703f22f.jpg\" width=\"790\" height=\"820\"><br></p>',
         '4299.00', '9993', '1', '2017-04-13 19:07:47', '2017-04-13 21:45:41');
COMMIT;

-- ----------------------------
--  Table structure for `ubaby_shipping`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_shipping`;
CREATE TABLE `ubaby_shipping` (
  `id`                INT(11) NOT NULL AUTO_INCREMENT,
  `user_id`           INT(11)          DEFAULT NULL
  COMMENT '用户id',
...
-- ----------------------------
--  Records of `ubaby_shipping`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_shipping` VALUES
...
-- ----------------------------
--  Table structure for `ubaby_user`
-- ----------------------------
DROP TABLE IF EXISTS `ubaby_user`;
CREATE TABLE `ubaby_user` (
  `id`          INT(11)     NOT NULL AUTO_INCREMENT
  COMMENT '用户表id',
...
-- ----------------------------
--  Records of `ubaby_user`
-- ----------------------------
BEGIN;
INSERT INTO `ubaby_user` VALUES
  ('1', 'admin', '427338237BD929443EC5D48E24FD2B1A', 'admin@happyubaby.com', '13800138000', '问题', '答案', '1',
   '2016-11-06 16:56:45', '2017-04-04 19:27:36'),
  ('13', 'geely', '08E9A6EA287E70E7E3F7C982BF7923AC', 'geely@happyubaby.com', '13800138000', '问题', '答案', '0',
   '2016-11-19 22:19:25', '2016-11-19 22:19:25'),
  ('17', 'rosen', '095AC193FE2212EEC7A93E8FEFF11902', 'rosen1@happyubaby.com', '13800138000', '问题', '答案', '0',
   '2017-03-17 10:51:33', '2017-04-09 23:13:26'),
  ('21', 'soonerbetter', 'DE6D76FE7C40D5A1A8F04213F2BEFBEE', 'test06@happyubaby.com', '13800138000', '105204', '105204',
